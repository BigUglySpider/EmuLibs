...
#pragma region PRE_TEST_BODY
	...
	std::cout << "\nCMPEQ\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAnyEqual(EmuMath::FastVector<3, float>(1, 2, 3)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAnyEqual(EmuMath::FastVector<3, float>(4, 4, 4)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAnyEqual(EmuMath::FastVector<3, float>(4, 2, 4)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAllEqual(EmuMath::FastVector<3, float>(1, 2, 3)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAllEqual(EmuMath::FastVector<3, float>(4, 4, 4)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAllEqual(EmuMath::FastVector<3, float>(4, 2, 4)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAnyEqual(EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAnyEqual(EmuMath::FastVector<7, float>(4, 4, 4, 5, 4, 4, 4)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAnyEqual(EmuMath::FastVector<7, float>(4, 4, 4, 6, 9, 2, 7)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAllEqual(EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAllEqual(EmuMath::FastVector<7, float>(4, 4, 4, 5, 4, 4, 4)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAllEqual(EmuMath::FastVector<7, float>(4, 4, 4, 6, 9, 2, 7)) << "\n";

	std::cout << "\nCMPNEQ\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAnyNotEqual(EmuMath::FastVector<3, float>(1, 2, 3)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAnyNotEqual(EmuMath::FastVector<3, float>(4, 4, 4)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAnyNotEqual(EmuMath::FastVector<3, float>(4, 2, 4)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAllNotEqual(EmuMath::FastVector<3, float>(1, 2, 3)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAllNotEqual(EmuMath::FastVector<3, float>(4, 4, 4)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(1, 2, 3).CmpAllNotEqual(EmuMath::FastVector<3, float>(4, 2, 4)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAnyNotEqual(EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAnyNotEqual(EmuMath::FastVector<7, float>(4, 4, 4, 5, 4, 4, 4)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAnyNotEqual(EmuMath::FastVector<7, float>(4, 4, 4, 6, 9, 2, 7)) << "\n";
	std::cout << EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7).CmpAllNotEqual(EmuMath::FastVector<7, float>(1, 2, 3, 4, 5, 6, 7)) << "\n";
	...
	std::cout << EmuMath::FastVector<2, double>(5, 7).AngleCos<fast_vec_rads>(EmuMath::FastVector<2, double>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, double>(5, 7, -16).AngleCos<fast_vec_rads>(EmuMath::FastVector<3, double>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, double>(5, 7, -16, 12).AngleCos<fast_vec_rads>(EmuMath::FastVector<4, double>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<2, float, 256>(5, 7).AngleCos<fast_vec_rads>(EmuMath::FastVector<2, float, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, float, 256>(5, 7, -16).AngleCos<fast_vec_rads>(EmuMath::FastVector<3, float, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, float, 256>(5, 7, -16, 12).AngleCos<fast_vec_rads>(EmuMath::FastVector<4, float, 256>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::FastVector<2, double, 256>(5, 7).AngleCos<fast_vec_rads>(EmuMath::FastVector<2, double, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, double, 256>(5, 7, -16).AngleCos<fast_vec_rads>(EmuMath::FastVector<3, double, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, double, 256>(5, 7, -16, 12).AngleCos<fast_vec_rads>(EmuMath::FastVector<4, double, 256>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<2, std::int32_t, 256>(5, 7).AngleCos<fast_vec_rads>(EmuMath::FastVector<2, std::int32_t, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, std::int16_t, 256>(5, 7, -16).AngleCos<fast_vec_rads>(EmuMath::FastVector<3, std::int16_t, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, std::int32_t, 256>(5, 7, -16, 12).AngleCos<fast_vec_rads, float>(EmuMath::FastVector<4, std::int32_t, 256>(2, 9, 8, 19)) << "\n";
	...
	std::cout << EmuMath::FastVector<4, float>(5, 7, -16, 12).Angle<fast_vec_rads>(EmuMath::FastVector<4, float>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::FastVector<2, double>(5, 7).Angle<fast_vec_rads>(EmuMath::FastVector<2, double>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, double>(5, 7, -16).Angle<fast_vec_rads>(EmuMath::FastVector<3, double>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, double>(5, 7, -16, 12).Angle<fast_vec_rads>(EmuMath::FastVector<4, double>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<2, float, 256>(5, 7).Angle<fast_vec_rads>(EmuMath::FastVector<2, float, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, float, 256>(5, 7, -16).Angle<fast_vec_rads>(EmuMath::FastVector<3, float, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, float, 256>(5, 7, -16, 12).Angle<fast_vec_rads>(EmuMath::FastVector<4, float, 256>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::FastVector<2, double, 256>(5, 7).Angle<fast_vec_rads>(EmuMath::FastVector<2, double, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, double, 256>(5, 7, -16).Angle<fast_vec_rads>(EmuMath::FastVector<3, double, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, double, 256>(5, 7, -16, 12).Angle<fast_vec_rads>(EmuMath::FastVector<4, double, 256>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<2, std::int32_t, 256>(5, 7).Angle<fast_vec_rads>(EmuMath::FastVector<2, std::int32_t, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, std::int16_t, 256>(5, 7, -16).Angle<fast_vec_rads>(EmuMath::FastVector<3, std::int16_t, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, std::int32_t, 256>(5, 7, -16, 12).Angle<fast_vec_rads, float>(EmuMath::FastVector<4, std::int32_t, 256>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::FastVector<2, std::int32_t, 256>(5, 7).Angle<fast_vec_rads, std::int32_t>(EmuMath::FastVector<2, std::int32_t, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, std::int32_t, 256>(5, 7, -16).Angle<fast_vec_rads, double>(EmuMath::FastVector<3, std::int32_t, 256>(2, 9, 8)) << "\n";
	...
	std::cout << "\nPROJECT_TO_PLANE\n";
	std::cout << EmuMath::FastVector<2, float>(5, 7).ProjectToPlane3(EmuMath::FastVector<2, float>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, float>(5, 7, -16).ProjectToPlane3(EmuMath::FastVector<3, float>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, float>(5, 7, -16, 12).ProjectToPlane3(EmuMath::FastVector<4, float>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::FastVector<2, double>(5, 7).ProjectToPlane3(EmuMath::FastVector<2, double>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, double>(5, 7, -16).ProjectToPlane3(EmuMath::FastVector<3, double>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, double>(5, 7, -16, 12).ProjectToPlane3(EmuMath::FastVector<4, double>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<2, float, 256>(5, 7).ProjectToPlane3(EmuMath::FastVector<2, float, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, float, 256>(5, 7, -16).ProjectToPlane3(EmuMath::FastVector<3, float, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, float, 256>(5, 7, -16, 12).ProjectToPlane3(EmuMath::FastVector<4, float, 256>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::FastVector<2, double, 256>(5, 7).ProjectToPlane3(EmuMath::FastVector<2, double, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, double, 256>(5, 7, -16).ProjectToPlane3(EmuMath::FastVector<3, double, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, double, 256>(5, 7, -16, 12).ProjectToPlane3(EmuMath::FastVector<4, double, 256>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::FastVector<2, std::int32_t, 256>(5, 7).ProjectToPlane3(EmuMath::FastVector<2, std::int32_t, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, std::int16_t, 256>(5, 7, -16).ProjectToPlane3(EmuMath::FastVector<3, std::int16_t, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, std::int32_t, 256>(5, 7, -16, 12).ProjectToPlane3<float>(EmuMath::FastVector<4, std::int32_t, 256>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::FastVector<2, std::int32_t, 256>(5, 7).ProjectToPlane3<std::int32_t>(EmuMath::FastVector<2, std::int32_t, 256>(2, 9)) << "\n";
	std::cout << EmuMath::FastVector<3, std::int32_t, 256>(5, 7, -16).ProjectToPlane3<double>(EmuMath::FastVector<3, std::int32_t, 256>(2, 9, 8)) << "\n";
	std::cout << EmuMath::FastVector<4, std::int32_t, 256>(5, 7, -16, 12).ProjectToPlane3<double>(EmuMath::FastVector<4, std::int32_t, 256>(2, 9, 8, 19)) << "\n";

	std::cout << "\nPROJECT_TO_PLANE (NORMAL)\n";
	std::cout << EmuMath::Vector<2, float>(5, 7).ProjectToPlane(EmuMath::Vector<2, float>(2, 9)) << "\n";
	std::cout << EmuMath::Vector<3, float>(5, 7, -16).ProjectToPlane(EmuMath::Vector<3, float>(2, 9, 8)) << "\n";
	std::cout << EmuMath::Vector<4, float>(5, 7, -16, 12).ProjectToPlane(EmuMath::Vector<4, float>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::Vector<2, double>(5, 7).ProjectToPlane(EmuMath::Vector<2, double>(2, 9)) << "\n";
	std::cout << EmuMath::Vector<3, double>(5, 7, -16).ProjectToPlane(EmuMath::Vector<3, double>(2, 9, 8)) << "\n";
	std::cout << EmuMath::Vector<4, double>(5, 7, -16, 12).ProjectToPlane(EmuMath::Vector<4, double>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::Vector<2, float>(5, 7).ProjectToPlane(EmuMath::Vector<2, float>(2, 9)) << "\n";
	std::cout << EmuMath::Vector<3, float>(5, 7, -16).ProjectToPlane(EmuMath::Vector<3, float>(2, 9, 8)) << "\n";
	std::cout << EmuMath::Vector<4, float>(5, 7, -16, 12).ProjectToPlane(EmuMath::Vector<4, float>(2, 9, 8, 19)) << "\n";
	...
	std::cout << EmuMath::Vector<4, double>(5, 7, -16, 12).ProjectToPlane(EmuMath::Vector<4, double>(2, 9, 8, 19)) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::Vector<2, std::int32_t>(5, 7).ProjectToPlane(EmuMath::Vector<2, std::int32_t>(2, 9)) << "\n";
	std::cout << EmuMath::Vector<3, std::int16_t>(5, 7, -16).ProjectToPlane(EmuMath::Vector<3, std::int16_t>(2, 9, 8)) << "\n";
	std::cout << EmuMath::Vector<4, std::int32_t>(5, 7, -16, 12).ProjectToPlane<float>(EmuMath::Vector<4, std::int32_t>(2, 9, 8, 19)) << "\n";
	std::cout << EmuMath::Vector<2, std::int32_t>(5, 7).ProjectToPlane<std::int32_t>(EmuMath::Vector<2, std::int32_t>(2, 9)) << "\n";
	...
	std::cout << EmuMath::Vector<2, float>(5, 7).ProjectToPlane3(EmuMath::Vector<2, float>(2, 9), fast_normal_b.Convert<2, float>().Store(), fast_normal_c.Convert<2, float>().Store()) << "\n";
	std::cout << EmuMath::Vector<3, float>(5, 7, -16).ProjectToPlane3(EmuMath::Vector<3, float>(2, 9, 8), fast_normal_b.Convert<3, float>().Store(), fast_normal_c.Convert<3, float>().Store()) << "\n";
	std::cout << EmuMath::Vector<4, float>(5, 7, -16, 12).ProjectToPlane3(EmuMath::Vector<4, float>(2, 9, 8, 19), fast_normal_b.Convert<4, float>().Store(), fast_normal_c.Convert<4, float>().Store()) << "\n";
	std::cout << EmuMath::Vector<2, double>(5, 7).ProjectToPlane3(EmuMath::Vector<2, double>(2, 9), fast_normal_b.Convert<2, double>().Store(), fast_normal_c.Convert<2, double>().Store()) << "\n";
	std::cout << EmuMath::Vector<3, double>(5, 7, -16).ProjectToPlane3(EmuMath::Vector<3, double>(2, 9, 8), fast_normal_b.Convert<3, double>().Store(), fast_normal_c.Convert<3, double>().Store()) << "\n";
	std::cout << EmuMath::Vector<4, double>(5, 7, -16, 12).ProjectToPlane3(EmuMath::Vector<4, double>(2, 9, 8, 19), fast_normal_b.Convert<4, double>().Store(), fast_normal_c.Convert<4, double>().Store()) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::Vector<2, float>(5, 7).ProjectToPlane3(EmuMath::Vector<2, float>(2, 9), fast_normal_b.Convert<2, float, 256>().Store(), fast_normal_c.Convert<2, float, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<3, float>(5, 7, -16).ProjectToPlane3(EmuMath::Vector<3, float>(2, 9, 8), fast_normal_b.Convert<3, float, 256>().Store(), fast_normal_c.Convert<3, float, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<4, float>(5, 7, -16, 12).ProjectToPlane3(EmuMath::Vector<4, float>(2, 9, 8, 19), fast_normal_b.Convert<4, float, 256>().Store(), fast_normal_c.Convert<4, float, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<2, double>(5, 7).ProjectToPlane3(EmuMath::Vector<2, double>(2, 9), fast_normal_b.Convert<2, double, 256>().Store(), fast_normal_c.Convert<2, double, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<3, double>(5, 7, -16).ProjectToPlane3(EmuMath::Vector<3, double>(2, 9, 8), fast_normal_b.Convert<3, double, 256>().Store(), fast_normal_c.Convert<3, double, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<4, double>(5, 7, -16, 12).ProjectToPlane3(EmuMath::Vector<4, double>(2, 9, 8, 19), fast_normal_b.Convert<4, double, 256>().Store(), fast_normal_c.Convert<4, double, 256>().Store()) << "\n";
	std::cout << "---\n";
	std::cout << EmuMath::Vector<2, std::int32_t>(5, 7).ProjectToPlane3(EmuMath::Vector<2, std::int32_t>(2, 9), fast_normal_b.Convert<2, std::int32_t, 256>().Store(), fast_normal_c.Convert<2, std::int32_t, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<3, std::int16_t>(5, 7, -16).ProjectToPlane3(EmuMath::Vector<3, std::int16_t>(2, 9, 8), fast_normal_b.Convert<3, std::int16_t, 256>().Store(), fast_normal_c.Convert<3, std::int16_t, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<4, std::int32_t>(5, 7, -16, 12).ProjectToPlane3<float>(EmuMath::Vector<4, std::int32_t>(2, 9, 8, 19), fast_normal_b.Convert<4, std::int32_t, 256>().Store(), fast_normal_c.Convert<4, std::int32_t, 256>().Store()) << "\n";
	std::cout << EmuMath::Vector<2, std::int32_t>(5, 7).ProjectToPlane3<std::int32_t>(EmuMath::Vector<2, std::int32_t>(2, 9), fast_normal_b.Convert<2, std::int32_t, 256>().Store(), fast_normal_c.Convert<2, std::int32_t, 256>().Store()) << "\n";
