#ifndef EMU_SIMD_HELPERS_UNDERLYING_BLEND_MASK_H_INC_
#define EMU_SIMD_HELPERS_UNDERLYING_BLEND_MASK_H_INC_ 1
	...
	private:
		[[nodiscard]] static constexpr inline bool _do_check()
		{
			...
			if constexpr (_is_valid_blend_mask<mask_generator>::value)
			{
				...
				return EmuSIMD::TMP::is_simd_register_v<return_type>;
			}
			else
			{
				return false;
