...
#pragma region SETTERS
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 setmasked_u8x32(std::uint32_t bit_mask_)
	{
		...
		(
			static_cast<std::uint8_t>(bit_mask_  & 0x00000001)        * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000002) >> 1)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000004) >> 2)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000008) >> 3)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000010) >> 4)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000020) >> 5)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000040) >> 6)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000080) >> 7)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000100) >> 8)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000200) >> 9)  * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000400) >> 10) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00000800) >> 11) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00001000) >> 12) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00002000) >> 13) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00004000) >> 14) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00008000) >> 15) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00010000) >> 16) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00020000) >> 17) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00040000) >> 18) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00080000) >> 19) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00100000) >> 20) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00200000) >> 21) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00400000) >> 22) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x00800000) >> 23) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x01000000) >> 24) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x02000000) >> 25) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x04000000) >> 26) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x08000000) >> 27) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x10000000) >> 28) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x20000000) >> 29) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x40000000) >> 30) * element_mask,
			static_cast<std::uint8_t>((bit_mask_ & 0x80000000) >> 31) * element_mask
		);
	}

	template<std::uint32_t BitMask_>
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 setmasked_u8x32()
	{
	...
	>
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 set_index_mask_u8x32()
	{
		if constexpr
		(
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 set_index_mask_u8x32()
	{
		...
		{
			return setmasked_u8x32<EmuSIMD::Funcs::make_all_indices_set_mask<32, Active_>()>();
		}
		else
		{
			return setzero_u8x32();
...
#else
		return _underlying_impl::emulate_simd_cast_lesser_width<u8x32>(a_);
#endif
	}
...
#pragma region CONVERSIONS
	...
	{
		return cvt_i32x4_u8x32(_mm_cvtps_epi32(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_f32x8_u8x32(f32x8_arg a_)
	{
		return cvt_i32x8_u8x32(_mm256_cvtps_epi32(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_f32x16_u8x32(f32x16_arg a_)
	{
#if EMU_SIMD_USE_512_REGISTERS
		return cvt_i32x16_u8x32(_mm512_cvtps_epi32(a_));
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 16, true, float>(a_, std::make_index_sequence<32>());
#endif
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_f64x2_u8x32(f64x2_arg a_)
	{
		return cvt_i32x4_u8x32(_mm_cvtpd_epi32(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_f64x4_u8x32(f64x4_arg a_)
	{
		return cvt_i32x4_u8x32(_mm256_cvtpd_epi32(a_));
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 8, true, double>(a_, std::make_index_sequence<32>());
#endif
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 8, true, std::int16_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_i32x4_u8x32(i32x4_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 4, true, std::int32_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_i64x2_u8x32(i64x2_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 2, true, std::int64_t>(a_, std::make_index_sequence<32>());
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 16, true, std::int16_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_i32x8_u8x32(i32x8_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 8, true, std::int32_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_i64x4_u8x32(i64x4_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 4, true, std::int64_t>(a_, std::make_index_sequence<32>());
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 32, true, std::int16_t>(a_, std::make_index_sequence<32>());
#endif
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 16, true, std::int32_t>(a_, std::make_index_sequence<32>());
#endif
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 8, true, std::int64_t>(a_, std::make_index_sequence<32>());
#endif
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 8, false, std::uint16_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_u32x4_u8x32(u32x4_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 4, false, std::uint32_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_u64x2_u8x32(u64x2_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 2, false, std::uint64_t>(a_, std::make_index_sequence<32>());
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 16, false, std::uint16_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_u32x8_u8x32(u32x8_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 8, false, std::uint32_t>(a_, std::make_index_sequence<32>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_u64x4_u8x32(u64x4_arg a_)
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 4, false, std::uint64_t>(a_, std::make_index_sequence<32>());
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_u16x32_u8x32(u16x32_arg a_)
	{
		...
		return _mm512_cvtepi16_epi8(a_);
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 32, false, std::uint16_t>(a_, std::make_index_sequence<32>());
#endif
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_u32x16_u8x32(u32x16_arg a_)
	{
		...
		return _mm256_castsi128_si256(_mm512_cvtepi32_epi8(a_));
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 16, false, std::uint32_t>(a_, std::make_index_sequence<32>());
#endif
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 cvt_u64x8_u8x32(u64x8_arg a_)
	{
		...
		return _mm256_castsi128_si256(_mm512_cvtepi64_epi8(a_));
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u8x32, std::uint8_t, 8, false, 8, false, std::uint64_t>(a_, std::make_index_sequence<32>());
#endif
	}
#pragma endregion
...
#pragma region MINMAX_FUNCS
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 horizontal_min_u8x32(EmuSIMD::u8x32_arg a_)
	{
		u8x16 lane = min_u8x16(cast_u8x32_u8x16(a_), extract_u8x32_lane_u8x16<1>(a_));
		return cast_u8x16_u8x32(horizontal_min_u8x16(lane));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 horizontal_min_fill_u8x32(EmuSIMD::u8x32_arg a_)
	{
		u8x16 lane = min_u8x16(cast_u8x32_u8x16(a_), extract_u8x32_lane_u8x16<1>(a_));
		lane = horizontal_min_fill_u8x16(lane);
		return _mm256_inserti128_si256(cast_u8x16_u8x32(lane), lane, 1);
	}

	template<typename Out_>
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 horizontal_min_scalar_u8x32(EmuSIMD::u8x32_arg a_)
	{
		u8x16 lane = min_u8x16(cast_u8x32_u8x16(a_), extract_u8x32_lane_u8x16<1>(a_));
		return horizontal_min_scalar_u8x16<Out_>(lane);
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 horizontal_max_u8x32(EmuSIMD::u8x32_arg a_)
	{
		u8x16 lane = max_u8x16(cast_u8x32_u8x16(a_), extract_u8x32_lane_u8x16<1>(a_));
		return cast_u8x16_u8x32(horizontal_max_u8x16(lane));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 horizontal_max_fill_u8x32(EmuSIMD::u8x32_arg a_)
	{
		u8x16 lane = max_u8x16(cast_u8x32_u8x16(a_), extract_u8x32_lane_u8x16<1>(a_));
		lane = horizontal_max_fill_u8x16(lane);
		return _mm256_inserti128_si256(cast_u8x16_u8x32(lane), lane, 1);
	}

	template<typename Out_>
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u8x32 horizontal_max_scalar_u8x32(EmuSIMD::u8x32_arg a_)
	{
		u8x16 lane = max_u8x16(cast_u8x32_u8x16(a_), extract_u8x32_lane_u8x16<1>(a_));
		return horizontal_max_scalar_u8x16<Out_>(lane);
	}
#pragma endregion
