...
#pragma region SETTERS
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 setmasked_f32x4()
	{
		if constexpr(BitMask_ != 0)
		{
#if EMU_SIMD_USE_128_REGISTERS
			return cast_u32x4_f32x4
			(
				set_u32x4
				(
...
#else
			return _underlying_impl::setmasked_single_lane_simd_emulator<4, float>(BitMask_);
#endif
		}
		else
		{
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 set_index_mask_f32x4()
	{
		if constexpr (I0_ || I1_ || I2_ || I3_)
		{
			return setmasked_f32x4<EmuSIMD::Funcs::make_index_set_mask<I0_, I1_, I2_, I3_>()>();
		}
		else
		{
			return setzero_f32x4();
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 set_index_mask_f32x4()
	{
		...
		{
			return setmasked_f32x4<EmuSIMD::Funcs::make_all_indices_set_mask<4, Active_>()>();
		}
		else
		{
			return setzero_f32x4();
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 4, true, double>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 8, true, double>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 32, true, std::int8_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 16, true, std::int16_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 8, true, std::int32_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 4, true, std::int64_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 64, true, std::int8_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 32, true, std::int16_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 16, true, std::int32_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 8, true, std::int64_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 32, false, std::uint8_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 16, false, std::uint16_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 8, false, std::uint32_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 4, false, std::uint64_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 64, false, std::uint8_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 32, false, std::uint16_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 16, false, std::uint32_t>(a_, std::make_index_sequence<4>());
#endif
	}
...
#else
		return _underlying_impl::emulate_cvt<EmuSIMD::f32x4, float, 32, true, 8, false, std::uint64_t>(a_, std::make_index_sequence<4>());
#endif
	}
#pragma endregion
...
#pragma region TRIG
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 cos_f32x4(EmuSIMD::f32x4_arg in_)
	{
		...
		EmuSIMD::f32x4 r1x = mul_all_f32x4(set1_f32x4(0.159154943091f), in_); // r1.x = c1.w * in_;
		...
		r2y = fmadd_f32x4(r2x, const1, fmadd_f32x4(r2y, const0, mul_all_f32x4(r2z, const1))); // dot(r2, c4.zwz)

		EmuSIMD::f32x4 r0x = negate_f32x4(r1y);
		EmuSIMD::f32x4 r0y = sub_f32x4(set1_f32x4(0.5f), r1y);
		EmuSIMD::f32x4 r0z = sub_f32x4(const0, r1y);
		r0x = mul_all_f32x4(r0x, r0x);
		r0y = mul_all_f32x4(r0y, r0y);
		r0z = mul_all_f32x4(r0z, r0z);
		...
		return fmadd_f32x4(r1x, r2x, fmadd_f32x4(r1y, r2y, mul_all_f32x4(r1z, r2z)));
		#endif
#else
		using EmuSIMD::_underlying_impl::emulate_simd_basic;
		using index_sequence = std::make_index_sequence<4>;
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 tan_f32x4(EmuSIMD::f32x4_arg in_)
	{
		...
		// Prepare for power series
		EmuSIMD::f32x4 const0 = permute_f32x4<make_shuffle_mask_32<0, 0, 0, 0>()>(c1x_c2x_c3x_c4x);
		EmuSIMD::f32x4 r1x_cos = mul_all_f32x4(set1_f32x4(0.159154943091f), in_);
		...
		EmuSIMD::f32x4 const1 = permute_f32x4<make_shuffle_mask_32<3, 3, 3, 3>()>(one_c2z_c3z_c4z);
		r2y_sin = fmadd_f32x4(r2x_sin, const1, fmadd_f32x4(r2y_sin, const0, mul_all_f32x4(r2z_sin, const1))); // dot(r2, c4.zwz)
		r2y_cos = fmadd_f32x4(r2x_cos, const1, fmadd_f32x4(r2y_cos, const0, mul_all_f32x4(r2z_cos, const1)));
		...
		r0x_sin = mul_all_f32x4(r0x_sin, r0x_sin);
		r0y_sin = mul_all_f32x4(r0y_sin, r0y_sin);
		r0z_sin = mul_all_f32x4(r0z_sin, r0z_sin);
		...
		r0x_cos = mul_all_f32x4(r0x_cos, r0x_cos);
		r0y_cos = mul_all_f32x4(r0y_cos, r0y_cos);
		r0z_cos = mul_all_f32x4(r0z_cos, r0z_cos);
		...
		r2x_sin = fmadd_f32x4(r1x_sin, r2x_sin, fmadd_f32x4(r1y_sin, r2y_sin, mul_all_f32x4(r1z_sin, r2z_sin)));
		r2x_cos = negate_f32x4(r2x_cos);
		r2y_cos = negate_f32x4(r2y_cos);
		r2z_cos = negate_f32x4(r2z_cos);
		r2x_cos = fmadd_f32x4(r1x_cos, r2x_cos, fmadd_f32x4(r1y_cos, r2y_cos, mul_all_f32x4(r1z_cos, r2z_cos)));
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 acos_f32x4(EmuSIMD::f32x4_arg in_)
	{
		...
		result = mul_all_f32x4(result, sqrt_f32x4(sub_f32x4(one, in_abs)));
		
		EmuSIMD::f32x4 tmp = mul_all_f32x4(set1_f32x4(2.0f), negation_mult);
		tmp = mul_all_f32x4(tmp, result);
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 asin_f32x4(EmuSIMD::f32x4_arg in_)
	{
		...
		tmp = mul_all_f32x4(sqrt_f32x4(tmp), result);
		result = set1_f32x4(3.14159265358979f * 0.5f);
		result = sub_f32x4(result, tmp);

		tmp = mul_all_f32x4(negation_mult, result);
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x4 atan2_f32x4(EmuSIMD::f32x4_arg y_, EmuSIMD::f32x4_arg x_)
	{
		...
		temp2 = mul_all_f32x4(temp1, temp2);

		EmuSIMD::f32x4 t4 = mul_all_f32x4(temp2, temp2);
		...
		temp2 = mul_all_f32x4(temp0, temp2);
