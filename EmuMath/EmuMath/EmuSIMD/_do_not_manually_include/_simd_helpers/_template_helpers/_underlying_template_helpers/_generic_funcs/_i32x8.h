...
#pragma region SETTERS
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 setmasked_i32x8()
	{
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 set_index_mask_i32x8()
	{
		if constexpr(I0_ || I1_ || I2_ || I3_ || I4_ || I5_ || I6_ || I7_)
		{
			return setmasked_i32x8<EmuSIMD::Funcs::make_index_set_mask<I0_, I1_, I2_, I3_, I4_, I5_, I6_, I7_>()>();
		}
		else
		{
			return setzero_i32x8();
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 set_index_mask_i32x8()
	{
		...
		{
			return setmasked_i32x8<EmuSIMD::Funcs::make_all_indices_set_mask<8, Active_>()>();
		}
		else
		{
			return setzero_i32x8();
...
#else
		return EmuSIMD::_underlying_impl::emulate_simd_cast_lesser_width<i32x8>(a_);
#endif
	}
...
#pragma region CONVERSIONS
	...
	{
		return cvt_f32x8_i32x8(cast_f32x16_f32x8(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 cvt_f64x2_i32x8(f64x2_arg a_)
	{
		return _mm256_castsi128_si256(_mm_cvtpd_epi32(a_));
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<i32x8, std::int32_t, 32, true, 8, true, double>(a_, std::make_index_sequence<8>());
#endif
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<i32x8, std::int32_t, 32, true, 2, true, std::int64_t>(a_, std::make_index_sequence<8>());
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<i32x8, std::int32_t, 32, true, 4, true, std::int64_t>(a_, std::make_index_sequence<8>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 cvt_i8x64_i32x8(i8x64_arg a_)
	{
		return cvt_i8x16_i32x8(cast_i8x64_i8x16(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 cvt_i16x32_i32x8(i16x32_arg a_)
	{
		return cvt_i16x8_i32x8(cast_i16x32_i16x8(a_));
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<i32x8, std::int32_t, 32, true, 8, true, std::int64_t>(a_, std::make_index_sequence<8>());
#endif
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<i32x8, std::int32_t, 32, true, 2, false, std::uint64_t>(a_, std::make_index_sequence<8>());
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<i32x8, std::int32_t, 32, true, 4, false, std::uint64_t>(a_, std::make_index_sequence<8>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 cvt_u8x64_i32x8(u8x64_arg a_)
	{
		return cvt_u8x16_i32x8(cast_u8x64_u8x16(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 cvt_u16x32_i32x8(u16x32_arg a_)
	{
		return cvt_u16x8_i32x8(cast_u16x32_u16x8(a_));
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 cvt_u64x8_i32x8(u64x8_arg a_)
	{
		...
		return _mm512_cvtepi64_epi32(a_);
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<i32x8, std::int32_t, 32, true, 8, false, std::uint64_t>(a_, std::make_index_sequence<8>());
#endif
	}
#pragma endregion
...
#pragma region MINMAX_FUNCS
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 horizontal_min_i32x8(EmuSIMD::i32x8_arg a_)
	{
		...
		return cast_i32x4_i32x8(horizontal_min_i32x4(lane));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 horizontal_min_fill_i32x8(EmuSIMD::i32x8_arg a_)
	{
		i32x4 lane = min_i32x4(cast_i32x8_i32x4(a_), extract_i32x8_lane_i32x4<1>(a_));
	...
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_min_scalar_i32x8(EmuSIMD::i32x8_arg a_)
		-> typename std::remove_cvref<Out_>::type
	{
		i32x4 lane = min_i32x4(cast_i32x8_i32x4(a_), extract_i32x8_lane_i32x4<1>(a_));
		return horizontal_min_scalar_i32x4<Out_>(lane);
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 horizontal_max_i32x8(EmuSIMD::i32x8_arg a_)
	{
		...
		return cast_i32x4_i32x8(horizontal_max_i32x4(lane));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i32x8 horizontal_max_fill_i32x8(EmuSIMD::i32x8_arg a_)
	{
		i32x4 lane = max_i32x4(cast_i32x8_i32x4(a_), extract_i32x8_lane_i32x4<1>(a_));
	...
	template<typename Out_>
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_max_scalar_i32x8(EmuSIMD::i32x8_arg a_)
		-> typename std::remove_cvref<Out_>::type
	{
		i32x4 lane = max_i32x4(cast_i32x8_i32x4(a_), extract_i32x8_lane_i32x4<1>(a_));
		return horizontal_max_scalar_i32x4<Out_>(lane);
	}
#pragma endregion
