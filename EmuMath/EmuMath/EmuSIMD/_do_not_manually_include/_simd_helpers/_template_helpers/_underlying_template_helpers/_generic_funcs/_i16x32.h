...
#pragma region CONVERSIONS
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i16x32 cvt_f32x4_i16x32(f32x4_arg a_)
	{
		...
		return cvt_i32x4_i16x32(_mm_cvtps_epi32(a_));
#else
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i16x32 cvt_f32x8_i16x32(f32x8_arg a_)
	{
		...
		return cvt_i32x8_i16x32(_mm256_cvtps_epi32(a_));
#else
	...
	{
#if EMU_SIMD_USE_128_REGISTERS
		return cvt_i32x4_i16x32(_mm_cvtpd_epi32(a_));
#else
	...
	{
#if EMU_SIMD_USE_256_REGISTERS
		return cvt_i32x4_i16x32(_mm256_cvtpd_epi32(a_));
#else
	...
	{
#if EMU_SIMD_USE_128_REGISTERS
		return cast_i16x8_i16x32(cvt_i32x4_i16x8(a_));
#else
	...
	{
#if EMU_SIMD_USE_128_REGISTERS
		return cast_i16x8_i16x32(cvt_i64x2_i16x8(a_));
#else
	...
	{
#if EMU_SIMD_USE_256_REGISTERS
		return cast_i16x8_i16x32(cvt_i32x8_i16x8(a_));
#else
	...
	{
#if EMU_SIMD_USE_256_REGISTERS
		return cast_i16x8_i16x32(cvt_i64x4_i16x8(a_));
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<i16x32, std::int16_t, 16, true, 4, true, std::int64_t>(a_, std::make_index_sequence<32>());
#endif
	}
	...
	{
#if EMU_SIMD_USE_128_REGISTERS
		return cast_i16x8_i16x32(cvt_u32x4_i16x8(a_));
#else
	...
	{
#if EMU_SIMD_USE_128_REGISTERS
		return cast_i16x8_i16x32(cvt_u64x2_i16x8(a_));
#else
	...
	{
#if EMU_SIMD_USE_256_REGISTERS
		return cast_i16x8_i16x32(cvt_u32x8_i16x8(a_));
#else
	...
	{
#if EMU_SIMD_USE_256_REGISTERS
		return cast_i16x8_i16x32(cvt_u64x4_i16x8(a_));
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<i16x32, std::int16_t, 16, true, 4, false, std::uint64_t>(a_, std::make_index_sequence<32>());
#endif
	}
...
#pragma region COMPARISONS
	...
	{
#if EMU_SIMD_USE_512_REGISTERS
		return setmasked_i16x32(_mm512_cmpgt_epi16_mask(rhs_, lhs_));
#else
	...
	{
#if EMU_SIMD_USE_512_REGISTERS
		return setmasked_i16x32(_mm512_cmpge_epi16_mask(rhs_, lhs_));
#else
...
#pragma region MINMAX_FUNCS
	...
	{
#if EMU_SIMD_USE_512_REGISTERS
		i16x16 lane = min_i16x16(cast_i16x32_i16x16(a_), extract_i16x32_lane_i16x16<1>(a_));
		return cast_i16x16_i16x32(horizontal_min_i16x16(lane));
#else
		return EmuSIMD::_underlying_impl::emulate_horizontal_min_or_max<false, 16, true>(a_);
#endif
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i16x32 horizontal_min_fill_i16x32(EmuSIMD::i16x32_arg a_)
	{
#if EMU_SIMD_USE_512_REGISTERS
		i16x16 lane = min_i16x16(cast_i16x32_i16x16(a_), extract_i16x32_lane_i16x16<1>(a_));
		lane = horizontal_min_i16x16(lane);
		return _mm512_inserti32x8(cast_i16x16_i16x32(lane), lane, 1);
#else
		return EmuSIMD::_underlying_impl::emulate_horizontal_min_or_max<false, 16, true>(a_);
#endif
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_min_scalar_i16x32(EmuSIMD::i16x32_arg a_)
		-> typename std::remove_cvref<Out_>::type
	{
#if EMU_SIMD_USE_512_REGISTERS
		i16x16 lane = min_i16x16(cast_i16x32_i16x16(a_), extract_i16x32_lane_i16x16<1>(a_));
		return horizontal_min_scalar_i16x16<Out_>(lane);
#else
	...
	{
#if EMU_SIMD_USE_512_REGISTERS
		i16x16 lane = max_i16x16(cast_i16x32_i16x16(a_), extract_i16x32_lane_i16x16<1>(a_));
		return cast_i16x16_i16x32(horizontal_max_i16x16(lane));
#else
		return EmuSIMD::_underlying_impl::emulate_horizontal_min_or_max<true, 16, true>(a_);
#endif
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::i16x32 horizontal_max_fill_i16x32(EmuSIMD::i16x32_arg a_)
	{
#if EMU_SIMD_USE_512_REGISTERS
		i16x16 lane = max_i16x16(cast_i16x32_i16x16(a_), extract_i16x32_lane_i16x16<1>(a_));
		lane = horizontal_max_i16x16(lane);
		return _mm512_inserti32x8(cast_i16x16_i16x32(lane), lane, 1);
#else
		return EmuSIMD::_underlying_impl::emulate_horizontal_min_or_max<true, 16, true>(a_);
#endif
	...
	template<typename Out_>
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_max_scalar_i16x32(EmuSIMD::i16x32_arg a_)
		-> typename std::remove_cvref<Out_>::type
	{
#if EMU_SIMD_USE_512_REGISTERS
		i16x16 lane = max_i16x16(cast_i16x32_i16x16(a_), extract_i16x32_lane_i16x16<1>(a_));
		return horizontal_max_scalar_i16x16<Out_>(lane);
#else
		return EmuSIMD::_underlying_impl::emulate_horizontal_min_or_max_scalar<Out_, true, 16, true>(a_);
#endif
	}
#pragma endregion
