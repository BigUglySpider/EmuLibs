...
#pragma region SETTERS
	...
	{
		return _mm256_loadu_ps(p_to_load_);
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x8 setmasked_f32x8()
	{
		if constexpr(BitMask_ != 0)
		{
			return cast_u32x8_f32x8
			(
				set_u32x8
				(
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x8 set_index_mask_f32x8()
	{
		if constexpr (I0_ || I1_ || I2_ || I3_ || I4_ || I5_ || I6_ || I7_)
		{
			return setmasked_f32x8<EmuSIMD::Funcs::make_index_set_mask<I0_, I1_, I2_, I3_, I4_, I5_, I6_, I7_>()>();
		}
		else
		{
			return setzero_f32x8();
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x8 set_index_mask_f32x8()
	{
		...
		{
			return setmasked_f32x8<EmuSIMD::Funcs::make_all_indices_set_mask<8, Active_>()>();
		}
		else
		{
			return setzero_f32x8();
...
#pragma region STORES
	...
	{
		return get_first_f32x4(cast_f32x8_f32x4(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC std::uint8_t movemask_f32x8(f32x8_arg a_)
	{
		return static_cast<std::uint8_t>(_mm256_movemask_ps(a_));
	}
#pragma endregion
...
#pragma region BITWISE_ARITHMETIC
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x8 and_f32x8(EmuSIMD::f32x8_arg lhs_, EmuSIMD::f32x8_arg rhs_)
	{
		...
		return emulate_simd_basic([](f32x4_arg a_, f32x4_arg b_) { return EmuSIMD::Funcs::and_f32x4(a_, b_); }, lhs_, rhs_);
#endif
	}
...
#else
		using EmuSIMD::_underlying_impl::emulate_simd_basic;
		return emulate_simd_basic([](f32x4_arg a_, f32x4_arg b_) { return EmuSIMD::Funcs::or_f32x4(a_, b_); }, lhs_, rhs_);
#endif
	}
...
#else
		using EmuSIMD::_underlying_impl::emulate_simd_basic;
		return emulate_simd_basic([](f32x4_arg a_, f32x4_arg b_) { return EmuSIMD::Funcs::xor_f32x4(a_, b_); }, lhs_, rhs_);
#endif
	}
...
#else
		using EmuSIMD::_underlying_impl::emulate_simd_basic;
		return emulate_simd_basic([](f32x4_arg a_, f32x4_arg b_) { return EmuSIMD::Funcs::andnot_f32x4(a_, b_); }, not_lhs_, rhs_);
#endif
	}

	template<std::int32_t NumShifts_>
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x8 shift_left_f32x8(EmuSIMD::f32x8_arg lhs_)
	{
		return cast_i32x8_f32x8
		(
			shift_left_i32x8<NumShifts_>(cast_f32x8_i32x8(lhs_))
		);
	}
...
#pragma region NEAR_COMPARISONS
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x8 cmpnear_f32x8(EmuSIMD::f32x8_arg lhs_, EmuSIMD::f32x8_arg rhs_, EmuSIMD::f32x8_arg epsilon)
	{
...
#pragma region TRIG
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::f32x8 cos_f32x8(EmuSIMD::f32x8_arg in_)
	{
		...
		const0 = permute_f32x8<make_shuffle_mask_32<0, 0, 0, 0>()>(one_c2z_c3z_c4z);
		...
		// Begin power series
		// --- Power 1
		const0 = permute_f32x8<make_shuffle_mask_32<1, 1, 1, 1>()>(one_c2z_c3z_c4z);
		const1 = permute_f32x8<make_shuffle_mask_32<1, 1, 1, 1>()>(c1x_c2x_c3x_c4x);
		...
		// --- Power 2
		const0 = permute_f32x8<make_shuffle_mask_32<2, 2, 2, 2>()>(c1x_c2x_c3x_c4x);
		r1x = fmadd_f32x8(r1x, r0x, const0);
		r1y = fmadd_f32x8(r1y, r0y, set1_f32x8(-85.4537887573f));
		r1z = fmadd_f32x8(r1z, r0z, const0);

		// --- Power 3
		const0 = permute_f32x8<make_shuffle_mask_32<2, 2, 2, 2>()>(one_c2z_c3z_c4z);
		r1x = fmadd_f32x8(r1x, r0x, const0);
		r1y = fmadd_f32x8(r1y, r0y, set1_f32x8(64.9393539429f));
		r1z = fmadd_f32x8(r1z, r0z, const0);

		// --- Power 4
		const0 = permute_f32x8<make_shuffle_mask_32<3, 3, 3, 3>()>(c1x_c2x_c3x_c4x);
		r1x = fmadd_f32x8(r1x, r0x, const0);
		...
		// --- Power 5
		const0 = permute_f32x8<make_shuffle_mask_32<0, 0, 0, 0>()>(one_c2z_c3z_c4z);
		const1 = permute_f32x8<make_shuffle_mask_32<3, 3, 3, 3>()>(one_c2z_c3z_c4z);
