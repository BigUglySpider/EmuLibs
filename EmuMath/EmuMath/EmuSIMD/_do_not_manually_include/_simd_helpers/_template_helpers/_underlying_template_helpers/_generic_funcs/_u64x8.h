...
#pragma region BASIC_ARITHMETIC
	...
	{
		return _mm512_cvtpd_epu64(_mm512_sqrt_pd(_mm512_cvtepu64_pd(in_)));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u64x8 rsqrt_u64x8(EmuSIMD::u64x8_arg in_)
	{
		return _mm512_cvtpd_epu64(_mm512_div_pd(_mm512_set1_pd(1.0), _mm512_sqrt_pd(_mm512_cvtepu64_pd(in_))));
	}
#pragma endregion
}
