...
namespace EmuSIMD
{
	...
	{
	private:
		using _mask_generator = EmuSIMD::_underlying_simd_helpers::_make_movemask<Register_, IndexBits_...>;
		[[nodiscard]] static constexpr inline bool _is_valid()
		{
			return EmuSIMD::_underlying_simd_helpers::_is_valid_make_movemask_instance<_mask_generator>::value;
		}
