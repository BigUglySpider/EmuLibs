		...
		-> typename std::remove_cvref<ToRegister_>::type
	{
		...
		if constexpr (EmuSIMD::TMP::is_simd_register_v<from_uq>)
		{
			...
			if constexpr (EmuSIMD::TMP::is_simd_register_v<to_uq>)
			{
				...
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_f32x4<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::f32x8>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_f32x8<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::f32x16>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_f32x16<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::f64x2>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_f64x2<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::f64x4>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_f64x4<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::f64x8>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_f64x8<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i128_generic>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i32x4<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i256_generic>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i32x8<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i512_generic>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i32x16<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i8x16>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i8x16<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i8x32>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i8x32<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i8x64>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i8x64<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i16x8>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i16x8<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i16x16>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i16x16<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i16x32>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i16x32<ToRegister_>(from_);
				}
				...
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i64x2<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i64x4>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i64x4<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::i64x8>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_i64x8<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u8x16>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u8x16<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u8x32>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u8x32<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u8x64>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u8x64<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u16x8>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u16x8<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u16x16>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u16x16<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u16x32>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u16x32<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u32x4>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u32x4<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u32x8>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u32x8<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u32x16>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u32x16<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u64x2>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u64x2<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u64x4>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u64x4<ToRegister_>(from_);
				}
				else if constexpr (std::is_same_v<from_uq, EmuSIMD::u64x8>)
				{
					return EmuSIMD::_underlying_simd_helpers::_cast_u64x8<ToRegister_>(from_);
				}
				else
				{
