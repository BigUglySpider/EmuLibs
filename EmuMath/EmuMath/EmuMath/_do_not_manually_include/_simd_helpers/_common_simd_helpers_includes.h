#ifndef EMU_MATH_COMMON_SIMD_HELPER_INCLUDES_H_INC_
#define EMU_MATH_COMMON_SIMD_HELPER_INCLUDES_H_INC_ 1
...
#include "_template_helpers/_simd_helpers_template_movemask.h"
