#ifndef EMU_MATH_SIMD_HELPERS_TEMPLATE_CMP_H_INC_
#define EMU_MATH_SIMD_HELPERS_TEMPLATE_CMP_H_INC_ 1
...
namespace EmuMath::SIMD
{
	...
	[[nodiscard]] inline auto movemask(Register_ register_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::movemask, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline Register_ cmpeq(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmpeq, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline Register_ cmpneq(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmpneq, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline Register_ cmplt(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmplt, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline Register_ cmpgt(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmpgt, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline Register_ cmple(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmple, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline Register_ cmpge(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmpge, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline Register_ cmp(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_any_eq(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_any_eq, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_any_neq(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_any_neq, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_any_lt(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_any_lt, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_any_gt(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_any_gt, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_any_le(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_any_le, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_any_ge(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_any_ge, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_any(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_any, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	...
	[[nodiscard]] inline bool cmp_all_eq(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			if constexpr (_underlying_simd_helpers::_is_valid_make_movemask_instance<movemask_generator>::value)
			{
				...
				constexpr std::size_t int_width_ = num_index_args_ > 1 ? EmuMath::SIMD::TMP::simd_register_width_v<register_type_uq> / num_index_args_ : 8;
	...
	[[nodiscard]] inline bool cmp_all_neq(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_neq, but the passed IndexMustBeTrue_ arguments could not be used with the provided SIMD register to form a valid movemask. The number of boolean arguments must be equal to 1 or the number of elements contained within the register. If the register is integral, the number of arguments can be 1, register_width/64, register_width/32, register_width/16, or register_width/8, where the bit-width per element is determined as the denominator in these fractions.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_neq, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	template<bool SignedIfInt_ = true, class Register_>
	[[nodiscard]] inline bool cmp_all_neq(Register_ lhs_, Register_ rhs_)
	...
	[[nodiscard]] inline bool cmp_all_lt(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_lt, but the passed IndexMustBeTrue_ arguments could not be used with the provided SIMD register to form a valid movemask. The number of boolean arguments must be equal to 1 or the number of elements contained within the register. If the register is integral, the number of arguments can be 1, register_width/64, register_width/32, register_width/16, or register_width/8, where the bit-width per element is determined as the denominator in these fractions.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_lt, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	template<bool SignedIfInt_ = true, class Register_>
	[[nodiscard]] inline bool cmp_all_lt(Register_ lhs_, Register_ rhs_)
	...
	[[nodiscard]] inline bool cmp_all_gt(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_gt, but the passed IndexMustBeTrue_ arguments could not be used with the provided SIMD register to form a valid movemask. The number of boolean arguments must be equal to 1 or the number of elements contained within the register. If the register is integral, the number of arguments can be 1, register_width/64, register_width/32, register_width/16, or register_width/8, where the bit-width per element is determined as the denominator in these fractions.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_gt, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	template<bool SignedIfInt_ = true, class Register_>
	[[nodiscard]] inline bool cmp_all_gt(Register_ lhs_, Register_ rhs_)
	...
	[[nodiscard]] inline bool cmp_all_le(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_le, but the passed IndexMustBeTrue_ arguments could not be used with the provided SIMD register to form a valid movemask. The number of boolean arguments must be equal to 1 or the number of elements contained within the register. If the register is integral, the number of arguments can be 1, register_width/64, register_width/32, register_width/16, or register_width/8, where the bit-width per element is determined as the denominator in these fractions.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_le, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	template<bool SignedIfInt_ = true, class Register_>
	[[nodiscard]] inline bool cmp_all_le(Register_ lhs_, Register_ rhs_)
	...
	[[nodiscard]] inline bool cmp_all_ge(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_ge, but the passed IndexMustBeTrue_ arguments could not be used with the provided SIMD register to form a valid movemask. The number of boolean arguments must be equal to 1 or the number of elements contained within the register. If the register is integral, the number of arguments can be 1, register_width/64, register_width/32, register_width/16, or register_width/8, where the bit-width per element is determined as the denominator in these fractions.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all_ge, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
	template<bool SignedIfInt_ = true, class Register_>
	[[nodiscard]] inline bool cmp_all_ge(Register_ lhs_, Register_ rhs_)
	...
	[[nodiscard]] inline bool cmp_all(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all, but the passed IndexMustBeTrue_ arguments could not be used with the provided SIMD register to form a valid movemask. The number of boolean arguments must be equal to 1 or the number of elements contained within the register. If the register is integral, the number of arguments can be 1, register_width/64, register_width/32, register_width/16, or register_width/8, where the bit-width per element is determined as the denominator in these fractions.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::cmp_all, but the passed Register_ type is not recognised as a supported SIMD register.");
		}
	}
