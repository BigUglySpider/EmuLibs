#ifndef EMU_MATH_SIMD_HELPERS_UNDERLYING_INDEX_MASKS_H_INC_
#define EMU_MATH_SIMD_HELPERS_UNDERLYING_INDEX_MASKS_H_INC_ 1
...
#pragma region SINGLE_INDEX_MASK_ABSTRACTIONS
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m128, Index_>, "Invalid index provided when attempting to retrieve a single index mask for a __m128 SIMD register.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m256, Index_>, "Invalid index provided when attempting to retrieve a single index mask for a __m256 SIMD register.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m512, Index_>, "Invalid index provided when attempting to retrieve a single index mask for a __m512 SIMD register.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m128d, Index_>, "Invalid index provided when attempting to retrieve a single index mask for a __m128d SIMD register.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m256d, Index_>, "Invalid index provided when attempting to retrieve a single index mask for a __m256d SIMD register.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m512d, Index_>, "Invalid index provided when attempting to retrieve a single index mask for a __m512d SIMD register.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m128i, Index_, 8>, "Invalid index provided when attempting to retrieve a single index mask for a __m128i SIMD register with 8-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m128i, Index_, 16>, "Invalid index provided when attempting to retrieve a single index mask for a __m128i SIMD register with 16-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m128i, Index_, 32>, "Invalid index provided when attempting to retrieve a single index mask for a __m128i SIMD register with 32-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m128i, Index_, 64>, "Invalid index provided when attempting to retrieve a single index mask for a __m128i SIMD register with 64-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m256i, Index_, 8>, "Invalid index provided when attempting to retrieve a single index mask for a __m256i SIMD register with 8-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m256i, Index_, 16>, "Invalid index provided when attempting to retrieve a single index mask for a __m256i SIMD register with 16-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m256i, Index_, 32>, "Invalid index provided when attempting to retrieve a single index mask for a __m256i SIMD register with 32-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m256i, Index_, 64>, "Invalid index provided when attempting to retrieve a single index mask for a __m256i SIMD register with 64-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m512i, Index_, 8>, "Invalid index provided when attempting to retrieve a single index mask for a __m512i SIMD register with 8-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m512i, Index_, 16>, "Invalid index provided when attempting to retrieve a single index mask for a __m512i SIMD register with 16-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m512i, Index_, 32>, "Invalid index provided when attempting to retrieve a single index mask for a __m512i SIMD register with 32-bit elements.");
	...
	{
	private:
		static_assert(EmuMath::SIMD::TMP::valid_register_index_v<__m512i, Index_, 64>, "Invalid index provided when attempting to retrieve a single index mask for a __m512i SIMD register with 64-bit elements.");
...
#pragma region VALIDITY_TMP
	...
	{
		static constexpr bool value = EmuCore::TMPHelpers::has_static_get<_per_index_mask<Register_, ActiveIndices_...>>::value;
	};
