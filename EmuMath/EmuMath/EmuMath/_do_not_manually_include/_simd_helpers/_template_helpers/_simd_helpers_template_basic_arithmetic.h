#ifndef EMU_MATH_SIMD_HELPERS_TEMPLATE_BASIC_ARITHMETIC_H_INC_
#define EMU_MATH_SIMD_HELPERS_TEMPLATE_BASIC_ARITHMETIC_H_INC_ 1
...
namespace EmuMath::SIMD
{
	...
	[[nodiscard]] inline Register_ mod(Register_ lhs_, Register_ rhs_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::mod with an unsupported type as the passed Register_.");
		}
	}
	...
	[[nodiscard]] inline Register_ negate(Register_ register_)
	{
		...
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::negate with an unsupported type as the passed Register_.");
		}
	}
	...
	[[nodiscard]] inline Register_ fmadd(Register_ to_mult_lhs_, Register_ to_mult_rhs_, Register_ to_add_after_mult_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::fmadd with SIMD register that is not supported for this operation.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::fmadd with an unsupported type as the passed Register_.");
		}
	}
	...
	[[nodiscard]] inline Register_ fmsub(Register_ to_mult_lhs_, Register_ to_mult_rhs_, Register_ to_add_after_mult_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::fmsub with SIMD register that is not supported for this operation.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::fmsub with an unsupported type as the passed Register_.");
		}
	}
	...
	[[nodiscard]] inline Register_ fmaddsub(Register_ to_mult_lhs_, Register_ to_mult_rhs_, Register_ to_add_sub_after_mult_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::fmaddsub with SIMD register that is not supported for this operation.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::fmaddsub with an unsupported type as the passed Register_.");
		}
	}
	...
	[[nodiscard]] inline Register_ fmsubadd(Register_ to_mult_lhs_, Register_ to_mult_rhs_, Register_ to_sub_add_after_mult_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::fmsubadd with SIMD register that is not supported for this operation.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::fmsubadd with an unsupported type as the passed Register_.");
		}
	}
	...
	[[nodiscard]] inline Register_ addsub(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::addsub with SIMD register that is not supported for this operation.");
			}
		}
		else
		{
			static_assert(false, "Attempted to perform EmuMath::SIMD::addsub with an unsupported type as the passed Register_.");
		}
	}
	...
	[[nodiscard]] inline Register_ subadd(Register_ lhs_, Register_ rhs_)
	{
		...
		if constexpr (EmuMath::SIMD::TMP::is_simd_register_v<register_type_uq>)
		{
			...
			{
				static_assert(false, "Attempted to perform EmuMath::SIMD::subadd with SIMD register that is not supported for this operation.");
			}
		}
		else
		{
