...
#include "_misc_arithmetic/_matrix_clamp.h"
#include "_misc_arithmetic/_matrix_clamp_max.h"
...
#include "_misc_arithmetic/_matrix_max.h"
...
// CONTAINS:
// --- Includes for all files in _misc_arithmetic folder
