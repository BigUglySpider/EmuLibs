...
#pragma region CMP_NEAR_FUNCS
	...
	[[nodiscard]] constexpr inline bool new_vector_cmp_near(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_near(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_near(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
...
#pragma region CMP_NOT_NEAR_FUNCS
	...
	/// <returns>If Rhs_: is an EmuMath Vector: true if all comparisons are true, otherwise false. Otherwise, true if rhs_ is near-equal to lhs_vector_'s magnitude.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_not_near(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
	...
	/// <returns>True if all comparisons are true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_not_near(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if at least 1 comparison is true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_not_near(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
...
#pragma region CMP_EQUAL_FUNCS
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if all comparisons are true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if at least 1 comparison is true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
...
#pragma region CMP_NOT_EQUAL_FUNCS
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_not_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
	...
	/// <returns>True if all comparisons are true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_not_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if at least 1 comparison is true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_not_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
...
#pragma region CMP_GREATER_FUNCS
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_greater(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>True if all comparisons are true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_greater(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if at least 1 comparison is true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_greater(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
...
#pragma region CMP_LESS_FUNCS
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_less(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>True if all comparisons are true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_less(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if at least 1 comparison is true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_less(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
...
#pragma region CMP_GREATER_EQUAL_FUNCS
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_greater_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>True if all comparisons are true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_greater_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if at least 1 comparison is true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_greater_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
...
#pragma region CMP_LESS_EQUAL_FUNCS
	...
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_less_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>True if all comparisons are true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_all_less_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_and<void>;
	...
	/// <returns>True if at least 1 comparison is true, otherwise false.</returns>
	template<bool IncludeNonContained_ = true, class Rhs_, std::size_t LhsSize_, typename LhsT_>
	[[nodiscard]] constexpr inline bool new_vector_cmp_any_less_equal(const EmuMath::NewVector<LhsSize_, LhsT_>& lhs_vector_, Rhs_&& rhs_)
	{
		using Joiner_ = std::logical_or<void>;
