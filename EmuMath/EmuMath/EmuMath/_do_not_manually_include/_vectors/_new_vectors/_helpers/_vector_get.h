...
namespace EmuMath::Helpers
{
	...
	{
		return _vector_underlying::_vector_try_get<Size_, T_>(vector_, index_, pp_out_);
	}
	...
	{
		return _vector_underlying::_vector_try_get<Size_, T_>(vector_, index_, pp_const_out_);
	}
}
