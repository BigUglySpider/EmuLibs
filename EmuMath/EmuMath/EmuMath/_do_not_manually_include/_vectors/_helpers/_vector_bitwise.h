...
#pragma region BITWISE_NOT_FUNCS
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_not(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<InSize_, OutT_> vector_bitwise_not(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	vector_bitwise_not(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
	...
	/// <param name="in_vector_">EmuMath Vector to perform the bitwise NOT operation on.</param>
	template<std::size_t OutSize_, typename OutT_, std::size_t InSize_, typename InT_>
	constexpr inline void vector_bitwise_not(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_not_range(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<InSize_, OutT_> vector_bitwise_not_range(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<InSize_, InT_>::value_type_uq>
	vector_bitwise_not_range(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using in_value_uq = typename EmuMath::Vector<InSize_, InT_>::value_type_uq;
		using Func_ = EmuCore::do_bitwise_not<in_value_uq>;
	...
	constexpr inline void vector_bitwise_not_range(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_not_range_no_copy(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<InSize_, OutT_> vector_bitwise_not_range_no_copy(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<InSize_, InT_>::value_type_uq>
		vector_bitwise_not_range_no_copy(const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using in_value_uq = typename EmuMath::Vector<InSize_, InT_>::value_type_uq;
		using Func_ = EmuCore::do_bitwise_not<in_value_uq>;
	...
	constexpr inline void vector_bitwise_not_range_no_copy(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<InSize_, InT_>& in_vector_)
	{
		using Func_ = EmuCore::do_bitwise_not<typename EmuMath::Vector<InSize_, InT_>::value_type_uq>;
...
#pragma region BITWISE_AND_FUNCS
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_and(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_and(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_and
	(
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of ANDing.</param>
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	constexpr inline void vector_bitwise_and(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_and_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_and_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_and_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_and_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	constexpr inline void vector_bitwise_and_range(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_> vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_and_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_and_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_and_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_and_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	constexpr inline void vector_bitwise_and_range_no_copy(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
...
#pragma region BITWISE_OR_FUNCS
	...
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_or(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_bitwise_or, OutSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_or(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_bitwise_or, LhsSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<std::size_t OutSize_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_or
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of ORing.</param>
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	constexpr inline void vector_bitwise_or(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_or_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_or_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_or_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_or_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of ORing.</param>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename OutT_, std::size_t OutSize_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	constexpr inline void vector_bitwise_or_range(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_> vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_or_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_or_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_or_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_or_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	constexpr inline void vector_bitwise_or_range_no_copy(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
...
#pragma region BITWISE_XOR_FUNCS
	...
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_xor(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_bitwise_xor, OutSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_xor(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_bitwise_xor, LhsSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<std::size_t OutSize_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_xor
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of XORing.</param>
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	constexpr inline void vector_bitwise_xor(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_xor_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_xor_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_xor_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_xor_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of XORing.</param>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename OutT_, std::size_t OutSize_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	constexpr inline void vector_bitwise_xor_range(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_> vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_bitwise_xor_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_bitwise_xor_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_xor_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_bitwise_xor_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	constexpr inline void vector_bitwise_xor_range_no_copy(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
...
#pragma region SHIFT_LEFT_FUNCS
	...
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_shift_left(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_left_shift, OutSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_shift_left(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_left_shift, LhsSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<std::size_t OutSize_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_left
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of the shift operation.</param>
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	constexpr inline void vector_shift_left(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_shift_left_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_shift_left_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_left_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_left_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of the shift operation.</param>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename OutT_, std::size_t OutSize_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	constexpr inline void vector_shift_left_range(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_> vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_shift_left_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_shift_left_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_left_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_left_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	constexpr inline void vector_shift_left_range_no_copy(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
...
#pragma region SHIFT_RIGHT_FUNCS
	...
	/// <returns>EmuMath Vector of the desired OutSize_ (defaults to LhsSize_) and OutT_ (defaults to vector_lhs_'s value_type_uq), containing shift results.</returns>
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_shift_right(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_right_shift, OutSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_shift_right(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
		return EMU_MATH_VECTOR_MUTATE_TEMPLATE(EmuCore::do_right_shift, LhsSize_, OutT_)(vector_lhs_, std::forward<Rhs_>(rhs_));
	}
	template<std::size_t OutSize_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_right
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of the shift operation.</param>
	template<std::size_t OutSize_, typename OutT_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	constexpr inline void vector_shift_right(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	/// <returns>Copy of vector_lhs_, with shifting performed with the provided rhs_ as described within the specified index range.</returns>
	template<std::size_t OutSize_, typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_shift_right_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<typename OutT_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_shift_right_range(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, std::size_t BeginIndex_, std::size_t EndIndex_, std::size_t LhsSize_, typename LhsT_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_right_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_right_range
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of the shift operation.</param>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename OutT_, std::size_t OutSize_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	constexpr inline void vector_shift_right_range(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_> vector_lhs_, Rhs_&& rhs_)
	{
	...
	/// </returns>
	template<std::size_t OutSize_, typename OutT_, std::size_t OutBegin_, std::size_t OutEnd_, std::size_t ShiftBegin_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, OutT_> vector_shift_right_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<typename OutT_, std::size_t OutBegin_, std::size_t OutEnd_, std::size_t ShiftBegin_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, OutT_> vector_shift_right_range_no_copy(const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
	...
	template<std::size_t OutSize_, std::size_t OutBegin_, std::size_t OutEnd_, std::size_t ShiftBegin_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<OutSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_right_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	template<std::size_t OutBegin_, std::size_t OutEnd_, std::size_t ShiftBegin_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	[[nodiscard]] constexpr inline EmuMath::Vector<LhsSize_, typename EmuMath::Vector<LhsSize_, LhsT_>::value_type_uq> vector_shift_right_range_no_copy
	(
		const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_,
		Rhs_&& rhs_
	)
	...
	/// <param name="rhs_">: Scalar or EmuMath Vector appearing on the right-hand side of the shift operation.</param>
	template<std::size_t OutBegin_, std::size_t OutEnd_, std::size_t ShiftBegin_, typename OutT_, std::size_t OutSize_, typename LhsT_, std::size_t LhsSize_, typename Rhs_>
	constexpr inline void vector_shift_right_range_no_copy(EmuMath::Vector<OutSize_, OutT_>& out_vector_, const EmuMath::Vector<LhsSize_, LhsT_>& vector_lhs_, Rhs_&& rhs_)
	{
