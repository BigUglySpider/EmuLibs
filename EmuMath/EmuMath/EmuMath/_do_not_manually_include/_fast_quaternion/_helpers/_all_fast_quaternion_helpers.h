#ifndef EMU_MATH_ALL_FAST_QUATERNION_HELPERS_H_INC_
#define EMU_MATH_ALL_FAST_QUATERNION_HELPERS_H_INC_ 1
...
#include "_fast_quaternion_quaternion_operations.h"
