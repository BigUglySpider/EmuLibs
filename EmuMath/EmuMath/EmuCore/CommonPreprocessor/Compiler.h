...
#if defined(__INTEL_COMPILER) || defined(__ICC) || defined(__ECC) || defined(__ICL) || defined(__INTEL_COMPILER_BUILD_DATE)
	#define EMU_CORE_IS_INTEL_COMPILER 1 // // EmuCore has determined that this project is compiling under the Intel compiler
		#define EMU_CORE_IS_CLANG 0
		#define EMU_CORE_IS_GCC 0
		#define EMU_CORE_IS_INTEL_COMPILER 0
