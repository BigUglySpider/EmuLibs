...
namespace EmuMath::Helpers
{
	...
	constexpr inline EmuMath::Vector<Size_, T_>& vector_add_assign(EmuMath::Vector<Size_, T_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>Reference to lhs_vector_.</returns>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename T_, std::size_t Size_, typename Rhs_>
	constexpr inline EmuMath::Vector<Size_, T_>& vector_subtract_assign(EmuMath::Vector<Size_, T_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>Reference to lhs_vector_.</returns>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename T_, std::size_t Size_, typename Rhs_>
	constexpr inline EmuMath::Vector<Size_, T_>& vector_multiply_assign(EmuMath::Vector<Size_, T_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>Reference to lhs_vector_.</returns>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename T_, std::size_t Size_, typename Rhs_>
	constexpr inline EmuMath::Vector<Size_, T_>& vector_divide_assign(EmuMath::Vector<Size_, T_>& lhs_vector_, Rhs_&& rhs_)
	{
	...
	/// <returns>Reference to lhs_vector_.</returns>
	template<std::size_t BeginIndex_, std::size_t EndIndex_, typename T_, std::size_t Size_, typename Rhs_>
	constexpr inline EmuMath::Vector<Size_, T_>& vector_mod_assign(EmuMath::Vector<Size_, T_>& lhs_vector_, Rhs_&& rhs_)
	{
