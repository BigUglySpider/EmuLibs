...
#else
		return _underlying_impl::emulate_simd_cast_lesser_width<u32x8>(a_);
#endif
	}
...
#pragma region CONVERSIONS
	...
	{
		return cvt_f32x8_u32x8(cast_f32x16_f32x8(a_));
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u32x8, std::uint32_t, 32, false, 8, true, double>(a_, std::make_index_sequence<8>());
#endif
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u32x8, std::uint32_t, 32, false, 2, true, std::int64_t>(a_, std::make_index_sequence<8>());
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u32x8, std::uint32_t, 32, false, 4, true, std::int64_t>(a_, std::make_index_sequence<8>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u32x8 cvt_i8x64_u32x8(i8x64_arg a_)
	{
		return cvt_i8x16_u32x8(cast_i8x64_i8x16(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u32x8 cvt_i16x32_u32x8(i16x32_arg a_)
	{
		return cvt_i16x8_u32x8(cast_i16x32_i16x8(a_));
	}
...
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u32x8, std::uint32_t, 32, false, 8, true, std::int64_t>(a_, std::make_index_sequence<8>());
#endif
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u32x8, std::uint32_t, 32, false, 2, false, std::uint64_t>(a_, std::make_index_sequence<8>());
	}
	...
	{
		return EmuSIMD::_underlying_impl::emulate_cvt<u32x8, std::uint32_t, 32, false, 4, false, std::uint64_t>(a_, std::make_index_sequence<8>());
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u32x8 cvt_u8x64_u32x8(u8x64_arg a_)
	{
		return cvt_u8x16_u32x8(cast_u8x64_u8x16(a_));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u32x8 cvt_u16x32_u32x8(u16x32_arg a_)
	{
		return cvt_u16x8_u32x8(cast_u16x32_u16x8(a_));
	}
	...
	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u32x8 cvt_u64x8_u32x8(u64x8_arg a_)
	{
		...
		return _mm512_cvtepi64_epi32(a_);
#else
		return EmuSIMD::_underlying_impl::emulate_cvt<u32x8, std::uint32_t, 32, false, 8, false, std::uint64_t>(a_, std::make_index_sequence<8>());
#endif
	}
#pragma endregion
...
#pragma region MINMAX_FUNCS
	...
	{
		u32x4 lane = min_u32x4(cast_u32x8_u32x4(a_), extract_u32x8_lane_u32x4<1>(a_));
		return cast_u32x4_u32x8(horizontal_min_u32x4(lane));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u32x8 horizontal_min_fill_u32x8(EmuSIMD::u32x8_arg a_)
	{
		u32x4 lane = min_u32x4(cast_u32x8_u32x4(a_), extract_u32x8_lane_u32x4<1>(a_));
		lane = horizontal_min_fill_u32x4(lane);
		return _mm256_inserti128_si256(cast_u32x4_u32x8(lane), lane, 1);
	}

	template<typename Out_>
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_min_scalar_u32x8(EmuSIMD::u32x8_arg a_)
		-> typename std::remove_cvref<Out_>::type
	{
		u32x4 lane = min_u32x4(cast_u32x8_u32x4(a_), extract_u32x8_lane_u32x4<1>(a_));
		return horizontal_min_scalar_u32x4<Out_>(lane);
	}
	...
	{
		u32x4 lane = max_u32x4(cast_u32x8_u32x4(a_), extract_u32x8_lane_u32x4<1>(a_));
		return cast_u32x4_u32x8(horizontal_max_u32x4(lane));
	}

	EMU_SIMD_COMMON_FUNC_SPEC EmuSIMD::u32x8 horizontal_max_fill_u32x8(EmuSIMD::u32x8_arg a_)
	{
		u32x4 lane = max_u32x4(cast_u32x8_u32x4(a_), extract_u32x8_lane_u32x4<1>(a_));
		lane = horizontal_max_fill_u32x4(lane);
		return _mm256_inserti128_si256(cast_u32x4_u32x8(lane), lane, 1);
	}

	template<typename Out_>
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_max_scalar_u32x8(EmuSIMD::u32x8_arg a_)
		-> typename std::remove_cvref<Out_>::type
	{
		u32x4 lane = max_u32x4(cast_u32x8_u32x4(a_), extract_u32x8_lane_u32x4<1>(a_));
		return horizontal_max_scalar_u32x4<Out_>(lane);
	}
#pragma endregion
