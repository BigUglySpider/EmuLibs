...
#pragma region MINMAX_FUNCS
	...
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_min_scalar_i64x2(EmuSIMD::i64x2_arg a_)
	...
	template<typename Out_ = std::int64_t>
	EMU_SIMD_COMMON_FUNC_SPEC auto horizontal_max_scalar_i64x2(EmuSIMD::i64x2_arg a_)
		-> typename std::remove_cvref<Out_>::type;
#pragma endregion
...
#else
			return EmuSIMD::_underlying_impl::emulate_extraction<i64x2, 128, Index_>(a_);
#endif
		}
	}
